---
title: HashMap 源码分析
date: 2022-07-25 11:20:49
permalink: /pages/HashMap_SOURCE/
categories:
  - Java
  - 集合
tags:
...
![](https://oss.javaguide.cn/github/javaguide/java/collection/jdk1.7_hashmap.png)jdk1.8 之前的内部结构 - HashMap
...
![](https://oss.javaguide.cn/github/javaguide/java/collection/jdk1.8_hashmap.png)jdk1.8 之后的内部结构 - HashMap
...
- `new HashMap<>(4); ` 当初始容量小于 16 是，默认会变成 16
