...
![image-20230428155133580](http://md7.admin4j.com/blog/mysql/image-20230428155133580.png)
...
- **表空间（Tablespaces）**：用于存储表结构和数据。表空间又分为系统表空间、独立表空间、 通用表空间、临时表空间、Undo 表空间等多种类型；
  ...
  ![image-20230428164143885](http://md7.admin4j.com/blog/mysql/image-20230428164143885.png)
...
![image-20230428164440879](http://md7.admin4j.com/blog/mysql/image-20230428164440879.png)
...
![image-20230428164929118](http://md7.admin4j.com/blog/mysql/image-20230428164929118.png)
...
![image-20230428170914390](http://md7.admin4j.com/blog/mysql/image-20230428170914390.png)

## 3.2、InnoDB 文件存储格式

- 通过 SHOW TABLE STATUS 命令

  ![image-20230428171025837](http://md7.admin4j.com/blog/mysql/image-20230428171025837.png)
...
![image-20230428171300162](http://md7.admin4j.com/blog/mysql/image-20230428171300162.png)
...
- 实现多版本并发控制（MVCC）
  ...
  ![image-20230502085156692](http://md7.admin4j.com/blog/mysql/image-20230502085156692.png)
...
![image-20230502085711126](http://md7.admin4j.com/blog/mysql/image-20230502085711126.png)

### Redo Log 写入机制

Redo Log 文件内容是以**顺序循环**的方式写入文件，写满时则回溯到第一个文件，进行覆盖写。

![image-20230502085757722](http://md7.admin4j.com/blog/mysql/image-20230502085757722.png)
...
![image-20230502092753214](http://md7.admin4j.com/blog/mysql/image-20230502092753214.png)
...
![image-20230502094317546](http://md7.admin4j.com/blog/mysql/image-20230502094317546.png)
