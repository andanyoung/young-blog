...
![](../.vuepress/public/Spring boot/640-1687166632027-41.png)
...
![](../.vuepress/public/Spring boot/640-1687166632028-42.png)
...
![](../.vuepress/public/Spring boot/640-1687166632028-43.png)
...
![](../.vuepress/public/Spring boot/640-1687166632028-44.png)

为了避免此类错误导致服务启动异常，我们可以在引用变量的同时给它赋一个**默认值**，以确保即使在未正确配值的情况下，程序依然能够正常运行。
...
![](../.vuepress/public/Spring boot/640-1687166632028-45.png)
...
![](../.vuepress/public/Spring boot/640-1687166632029-46.png)

但是当我试图加载`.yaml`文件时，启动项目居然报错了，经过一番摸索我发现，@PropertySources 注解只内置了`PropertySourceFactory`适配器。也就是说它只能加载`.properties`文件。

![](../.vuepress/public/Spring boot/640-1687166632029-47.png)

那如果我想要加载一个`.yaml`类型文件，则**需要自行实现 yaml 的适配器** `YamlPropertySourceFactory`。
